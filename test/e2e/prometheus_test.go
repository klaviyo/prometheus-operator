...
import (
	...
	"github.com/klaviyo/prometheus-operator/pkg/alertmanager"
	...
	testFramework "github.com/klaviyo/prometheus-operator/test/framework"
)
...
func testPromRemoteWriteWithTLS(t *testing.T) {
	...
	var tests = []testFramework.PromRemoteWriteTestConfig{
		...
		// Had to change the success flag to True, because prometheus receiver is running in VerifyClientCertIfGiven mode. Details here - https://github.com/klaviyo/prometheus-operator/pull/4337#discussion_r735064646
		{
			Name: "variant-20",
			ClientKey: testFramework.Key{
				Filename:   "",
...
func testPromMultiplePrometheusRulesDifferentNS(t *testing.T) {
	...
	// See https://github.com/klaviyo/prometheus-operator/issues/3847
	for _, file := range ruleFiles {
...
func testPromOnlyUpdatedOnRelevantChanges(t *testing.T) {
	...
	// https://github.com/klaviyo/prometheus-operator/issues/1659). Added here to
...
// github.com/klaviyo/prometheus-operator/pkg/apis/monitoring/v1.PrometheusSpec.ArbitraryFSAccessThroughSMs
